...
abstract public class BaseChristmasFairTest {
  ...
  public void createDecorations() {
    decorations.add(new Light("Red", 120.50,
        EnumSet.of(DecorationType.HOUSE_INTERIOR, DecorationType.HOUSE_EXTERIOR, DecorationType.INDOOR_TREE), 250.0,
        20));
    ...
    decorations.add(new TreeToy("Green", 50.25, EnumSet.of(DecorationType.INDOOR_TREE, DecorationType.WORKING_PLACE),
        "sphere", 20));
